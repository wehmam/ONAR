                  ...
                  <div class="card-body p-md-5">
                    <div class="row justify-content-center">
                      <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                        ...
                        <form class="mx-1 mx-md-4" action="{{ url("backend/register") }}" method="POST">
                            @csrf
                            ...
                            <div class="d-flex flex-row align-items-center mb-4">
                                ...
                                <label class="form-label" for="name">Company Name @error('company_name')<span class="text-danger">* {{ $message }}</span>@enderror</label>
                                </div>
                            </div>
                            ...
                            {{-- <div class="d-flex flex-row align-items-center mb-4">
                                ...
                                <div class="form-outline flex-fill mb-0">
                                    ...
                                    <label class="form-label" for="phone">Phone @error('phone')<span class="text-danger">* {{ $message }}</span>@enderror</label>
                                </div>
                            </div> --}}
                            ...
                            <div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
                              <a href="{{ url("backend") }}" class="text-center">Login Creator</a>
                            </div>
                      ...
                      <div class="col-md-10 col-lg-6 col-xl-7 d-flex align-items-center order-1 order-lg-2">
                        ...
                        <img src="{{ asset("assets/frontend/img/creator.svg") }}"
